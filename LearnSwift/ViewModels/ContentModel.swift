...
//  LearnSwift
//
//  Created by Cristina on 2021-12-18.
//
...
class ContentModel: ObservableObject {
    ...
    func getLocalData() {
        ...
        // Parse the style data html file
        ...
        do {
            ...
            // Log error
            print("Coldnt't parse style data")
    ...
    func hasNextLesson() -> Bool {
        /* krotka wersja tego co ponizej:   return (currentLessonIndex + 1 < currentModule!.content.lessons.count)*/
